...
from Rollout_HJB_box_B2 import rollout_joint_levelB, rollout_eval_levelB
...
def finetune_stage2_levelB(
    ...
    eval0 = rollout_eval_levelB(policy, cfg, gcfg=gcfg, lam_choices=lam_choices, target_choices=target_choices,
                                batch_episodes=16, R=R, mv_allow_cash=mv_allow_cash, mv_solver=mv_solver, qp_solver=qp_solver, topk=topk)
...
if __name__ == "__main__":
    ...
    torch.save(policy.state_dict(), "policy_stage2_B2_finetuned.pt")
    torch.save(valuef.state_dict(), "value_stage2_B2_finetuned.pt")